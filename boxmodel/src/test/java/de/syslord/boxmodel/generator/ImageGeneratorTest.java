...
public class ImageGeneratorTest {
	...
	public void testName() throws Exception {
		...
		LayoutableBox line1 = new TextBox("line1", Lorem.Ips, 23, 20, 100, 30, FontProvider.getFont());
		line1.setPadding(10);
		line1.setProp(SizeProperty.MIN, 30);
		line1.setProp(SizeProperty.MAX, 100);

		LayoutableBox s = new TextBox("s", "nix", 500, 20, 100, 30, FontProvider.getFont());
		...
		LayoutableBox line2 = new TextBox("line2", Lorem.Ips, 27, 60, 100, 300, FontProvider.getFont());
		line2.setPadding(10);
		line2.setProp(SizeProperty.MIN, 1);
		line2.setProp(SizeProperty.MAX, 300);
		line2.setProp(PositionProperty.FLOAT);

		LayoutableBox line3 = new TextBox("line3", Lorem.Ipsum, 33, 100, 200, 30, FontProvider.getFont());
		line3.setPadding(7);
	...
	public void testMinMax() throws Exception {
		LayoutableBox root = new TextBox("root", Lorem.Ipsum, 0, 0, 1000, 700, FontProvider.getFont());
