...
public class LayouterTest {
	...
	public void testLayout_MinSize() throws Exception {
		...
		LayoutableBox root = new TextBox("root", "", 50, 50, 600, initialHeight, FontProvider.getFont());
	...
	public void testLayout_MaxSize() throws Exception {
		int initialHeight = 100;
		LayoutableBox root = new TextBox("root", Lorem.longIpsum, 50, 50, 200, initialHeight, FontProvider.getFont());
		root.setProp(SizeProperty.MAX, 400);
		root.setProp(SizeProperty.MIN, 200);
